...
//     return (
//         <header className="w-[85vw] sticky top-0 left-0 flex justify-end items-center bg-gray-200">
//             <div className="flex items-center gap-6">
//                 <div className="flex items-centercursor-pointer hover:text-black transition-transform ease-in-out" onClick={showAdminDetails}>
//                     {/* Avatar section */}
//                     {/* <div className="relative w-12 h-12 text-white rounded-full overflow-hidden cursor-pointer">
//                         {
//                             admin?.profile_Photo ?
//                                 <Image
